...
void menu(){
	printf("================== Bem-vindo(a) ==================\n");
	printf("================  Mercadinho Top ==================\n\n");

	printf("Selecione uma opcaoo abaixo: \n");
...
void listarProdutos(){
	if(contador_produto > 0){
		...
		printf("Nao temos produtos cadastrados D= \n\n");
		sleep(2);
		menu();
	}
}
...
void fecharPedido(){
	if(contador_carrinho > 0){
		...
		//limpar carrinho
		contador_carrinho = 0;
		printf("Obrigado pela preferencia! =D\n\n\n");
		Sleep(15);
		menu();
	}else{
		printf("Voce não tem nenhum produto no carrinho ainda, adicione!.\n");
		Sleep(3);
		menu();
	}
}
